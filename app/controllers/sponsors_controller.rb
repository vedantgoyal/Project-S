class SponsorsController < ApplicationController
  ...
  def new
    @sponsor = Sponsor.new
		@sponsor.project_id = params[:project_id]
  ...
  def create
    ...
    p_id = @sponsor.project_id 
    

    respond_to do |format|
      if !(Project.exists?(p_id))
   	    #  raise "Project with this project_id does not exist"   
        @sponsor.errors.add(:project_id, 'Does not exist')     
        format.html { render action: "new", notice: 'project_id was wrong' }
